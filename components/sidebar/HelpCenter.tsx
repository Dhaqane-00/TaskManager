...
export const HelpCenter: React.FC<HelpCenterProps> = ({ title, description, buttonText }) => {
  return (
    <div className="flex overflow-hidden flex-col text-xs tracking-tight text-center bg-gray-900 rounded-xl">
      <div className="flex flex-col pb-4 rounded-xl bg-gray-900 bg-opacity-0">
        ...
        <div className="flex flex-col items-center px-4 mt-4">
          ...
          <button className="self-stretch px-7 py-4 mt-11 text-gray-900 bg-white rounded-xl">
            {buttonText}
          </button>
        </div>
      </div>
